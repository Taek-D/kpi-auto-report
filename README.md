...
앳홈(미닉스/톰/프로티원) 브랜드별 매출을 수집하고, WoW 분석 + 이상 탐지 + 경쟁사 모니터링을 수행한 뒤 Slack으로 전송하는 n8n 기반 자동화 파이프라인입니다.
...
- [ ] Supabase 실제 테이블/RPC 생성 후 E2E 테스트
- [ ] 주간/월간 요약 리포트 추가
- [ ] Python 크롤링 스크립트 (쿠팡/네이버 자동 크롤링)
- [ ] Tableau 대시보드 연동
- [ ] 예측 분석 (ML 기반 트렌드 예측)
